        ...
        <div id="about" className="text-[var(--textLight1)] bg-[var(--bgLight2)] flex flex-col md:flex-row justify-between p-4 md:p-20">
            <div className="w-full md:w-2/3 p-4 md:p-10">
                ...
                <span id="descriptionAbout" className="relative text-center md:text-left">
                    A junior at IIIT-Hyderabad, I am interested in the fields of Math and Computer
                    Science. I am also a tech geek, programmer, undergraduate researcher and software developer. A cinephile, I dream to someday direct
                    a short film of my own. I am also interested in photography, music, and public speaking.
                </span><br />
            </div>
        </div>
    );
